...
\begin{frame}\frametitle{Vertical betatron motion dependence}
  \begin{figure}[H]
    ...
    \begin{subfigure}[t]{.5\textwidth}
      \includegraphics[width=\linewidth, trim=75 30 120 55, clip]{\decoh/ny_vs_y}
      \caption{SPA component $\bar n_y$ as a function of the vertical particle position.}
    \end{subfigure}~
    \begin{subfigure}[t]{.5\textwidth}
      \includegraphics[width=\linewidth, trim=75 30 120 55, clip]{\decoh/spin_tune_vs_y}
...
\begin{frame}\frametitle{Horizontal betatron motion dependence}
  \begin{figure}[H]
    \centering
    \begin{subfigure}[t]{.5\textwidth}
      \includegraphics[width=\linewidth, trim=75 30 120 55, clip]{\decoh/ny_vs_x}
      \caption{SPA component $\bar n_y$ as a function of the horizontal particle position.}
    \end{subfigure}~
    \begin{subfigure}[t]{.5\textwidth}
      \includegraphics[width=\linewidth, trim=75 30 120 55, clip]{\decoh/spin_tune_vs_x}
