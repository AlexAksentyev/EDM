...
\begin{frame}\frametitle{Individual particle ST+SPA structure}
  ...
  \caption{SPA component $\bar n_y$ for \textbf{particles} with offsets:
    ...
    offset (Figures~\ref{fig:mean_tune_offset} and~\ref{fig:mean_tune_axis} below). The rapid oscillations are
    due to betatron motion (Figures~\ref{fig:axis_on_traj_unopt},
    and~\ref{fig:axis_on_traj_opt}).\label{fig:ny_vs_turn}}
\end{figure}
\end{frame}

\begin{frame}\frametitle{Invariant spin axis}\framesubtitle{Unoptimized lattice}
  \begin{figure}[H]
    \centering
    \includegraphics[width=\linewidth]{../img/SEMINAR/NY_VS_YB_DATA_TRAJ_UNOPTIM}
    \caption{Sextupole fields are turned off\label{fig:axis_on_traj_unopt}}
  \end{figure}
\end{frame}

\begin{frame}\frametitle{Invariant spin axis}\framesubtitle{Optimized lattice}
  \begin{figure}[H]
    \centering
    \includegraphics[width=\linewidth]{../img/SEMINAR/NY_VS_YB_DATA_TRAJ_OPTIM}
    \caption{Sextupole fields are turned on\label{fig:axis_on_traj_opt}}
  \end{figure}
\end{frame}
...
\begin{frame}
  \begin{figure}[H]
    \centering
    \includegraphics[width=\linewidth, trim=85 25 120 60, clip]{\decoh/mean_spin_tune_vs_offset}
    \caption{Mean level of spin tune as a function of beam offset\label{fig:mean_tune_offset}}
  \end{figure}
\end{frame}

\begin{frame}
  \begin{figure}[H]
    \includegraphics[width=\linewidth, trim=85 25 120 60, clip]{\decoh/mean_nbar_vs_mean_spin_tune}
...
\begin{frame}\frametitle{Frequency estimate offset dependence}
  ...
  \begin{figure}[H]
    \centering
    \includegraphics[width=\linewidth, trim=85 25 120 60, clip]{\decoh/freqY_vs_offset}
...
\begin{frame}\frametitle{Spin tune dependence}
  \begin{figure}[H]
    \includegraphics[width=\linewidth, trim=85 25 120 55, clip]{\decoh/freqY_vs_mean_spin_tune}
...
\begin{frame}
  \begin{figure}[H]
    \includegraphics[width=\linewidth, trim=85 25 120 60, clip]{\decoh/freqY_vs_abs_offset}
