...
$\mu_i$ varies in the range $[-5\cdot10^{-4}, +5\cdot10^{-4}]$. The value of the standard deviation approximates
the practical element installation error.~\cite{Senichev:FDM} The expectation value $\mu_i$ simulates the
application of a Koop Spin Wheel.~\ref{Koop:SW} Imperfections
introduced this way (as rotations of E+B spin rotators) do not perturb the design orbit.
