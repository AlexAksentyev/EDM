...
One observes that the parameter estimates of all three series coincide within their respective
standard errors. Even though variation of the spin precession angular velocity vector worsened
the fit quality of model~\eqref{eq:fit_model},
it didn't introduce a statistically-significant bias into the estimates.
