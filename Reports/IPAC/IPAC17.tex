...
\author{A. E. Aksentev$^1$\footnotemark[2], Y. V. Senichev, Institut f\"ur Kernphysik, Forschungszentrum J\"ulich, J\"ulich, Germany \\$^1$ also at National Research Nuclear University ``MEPhI,'' Moscow, Russia}
...
\section{Conclusion}
Because in the proposed experiment the deuteron EDM is probed by measuring an oscillating function, a suggestion was made (by Y. V. Senichev, Dr. Sci. (private communication, December 2016)) that the experimental precision could be improved by the application of a frequency-modulated sampling strategy. In developing the statistical model, the concept of Fisher information was directly employed, which was instrumental in quantifying the gains in precision from both the increase in the duration of an experiment run, and sampling modulation. The model predicts that ultimately, the standard error of the frequency estimate can be improved by at the most a factor of $\sqrt{2}$, i.e. by 29\%; however, due to imprecision in the prerequisite frequency estimate, this improvement is inevitably weakened, down to 23\% in the present simulation.
