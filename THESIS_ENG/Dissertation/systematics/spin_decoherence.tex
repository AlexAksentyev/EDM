...
\begin{figure}[h!]
	\centering
	\subbottom[Full range.\label{decoh:fig:full:ST_vs_y0_GSY}]{%
		\includegraphics[width=\linewidth]{images/decoh_sim/spin_tune_vs_offset}}
	\subbottom[Detalization.$\label{decoh:fig:zoom:ST_vs_y0_GSY}]{%
...
\begin{figure}[h!]
	\centering
	\subbottom[Full range.\label{decoh:fig:full:ny_vs_y0_GSY}]{%
		\includegraphics[width=\linewidth]{images/decoh_sim/ny_vs_offset}}
	\subbottom[Detalization$.\label{decoh:fig:zoom:ny_vs_y0_GSY}]{%
